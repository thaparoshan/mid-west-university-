...
('ME403', 1, 1, 'T TH S', 304, 'TH1', 4, 39),
('ME410', 1, 2, 'T TH S', 304, 'TH3', 4, 40),
('ME412', 1, 4, 'T TH S', 304, 'M8', 4, 39),
...
(1, 'Sonalal Yadav', 'N'),
(2, 'Samya Deo Yadav', 'N'),
(3, 'Dhirendra Kumar Yada', 'N'),
(4, 'Prabin Bhusal', 'N'),
(5, 'Sabita Chand', 'N'),
(6, 'Basanta Regmi', 'N'),
(7, 'Viswanathan Yadav', 'N'),
(8, 'Basanta Rawot', 'N'),
(9, 'Kapil Budhathoki', 'N'),
(10, 'Mohan malla', 'N'),
(11, 'Depesh DC', 'N'),
(12, 'Srinivasa Reddy', 'N'),
(13, 'Parkash Panday', 'N'),
(14, 'Devendra lab Karna', 'N'),
(15, 'Ramesh Ghimire', 'N'),
(16, 'Ashasis Baral', 'N'),
(17, 'Denesh kadel', 'N'),
(18, 'Mahindra Thapa', 'N'),
...
(21, 'Roshan BC', 'N'),
(22, 'Sudip Thapa', 'N'),
(23, 'Ram Kumar Thapa', 'N'),
(24, 'Lalit Sharma', 'N'),
(25, 'Pawon Adhikari ', 'N'),
(26, 'Kishor Shrestha', 'N'),
(27, 'Mohan Thapa Magar', 'N'),
(28, 'Raju BC', 'N'),
(29, 'Rohini Pant', 'N'),
(30, 'Rajesh Katuwal', 'N'),
(31, 'Radha Malla', 'N'),
(32, 'Naresh Kumar Khadka', 'N'),
(33, 'Sugam Koirala', 'N'),
(34, 'Birendra Khadka', 'N'),
(35, 'Kishore Kumar', 'N'),
(36, 'Rama Karki', 'N'),
(37, 'Bikram jungThapa ', 'N'),
(38, 'Ashim Thapa ', 'N'),
(39, 'Nitan Gurung', 'N'),
(40, 'Ram Krishna', 'N'),
(41, 'Sanjeev Kumar Khadka', 'N'),
(42, 'Sree Ranjani', 'N'),
...
('sunday', 'EL211<br>MS', 'AM261<br>SH', 'CO207<br>', 'CO206<br>NA', '-<br>-', '-<br>-, -, -'),
...
('sunday', 'CO310<br>FA', 'ME340<br>FT', 'CO308<br>IZ', '-<br>-', '-<br>-', 'CO393<br>, FA, '),
...
('sunday', 'CO445<br>MHK', 'CO451<br>', 'CO448<br>NA', 'CO431<br>', '-<br>-', '-<br>-, -, -'),
...
(216, 'Roshan Thapa ', 4, 2, 'C.S.E', 'FST', '+9779868122', 'djroshanthapa@gmail.com', 'Y', 'N'),
(2014, 'Mukesh Thapa', 4, 2, 'C.S.E', 'FST', '9868025251', 'mukesh12@gmail.com', 'Y', 'N'),
(2015, 'Bharat khanal', 4, 2, 'CIVIL', 'FST', '9848346437', 'bharatkhl@gmail.com', 'Y', 'N');
...
('CO310', 'Operating Systems', 'THEORY', 5, 'HydroPower Engg. Dept.', 1, 'T013', '', ''),
...
('CO505', 'Python', 'THEORY', 8, 'Computer Engg.', 0, '', '', ''),
('SE501', 'vb.net', 'THEORY', 6, 'Computer Engg.', 0, '', '', '');
...
('sunday', '-<br>-', '-<br>-', '-<br>-', 'CO206<br>NL32', '-<br>-', '-'),
...
('sunday', '-<br>-', '-<br>-', 'CO308<br>ML10', '-<br>-', '-<br>-', '-'),
('monday', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-<br>-', 'CO494'),
('tuesday', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-'),
...
('sunday', '-<br>-', '-<br>-', 'CO448<br>ML04', '-<br>-', '-<br>-', '-'),
...
('sunday', 'CO445<br>ML04', 'CO451<br>ML04', '-<br>-', 'CO431<br>ML04', '-<br>-', '-'),
...
('sunday', 'CO310<br>ML10', '-<br>-', '-<br>-', '-<br>-', '-<br>-', 'CO393'),
...
('sunday', 'EL211<br>NL32', '-<br>-', '-<br>-', '-<br>-', '-<br>-', '-'),
...
('sunday', '-<br>-', 'AM261<br>NL32', 'CO207<br>NL32', '-<br>-', '-<br>-', '-'),
